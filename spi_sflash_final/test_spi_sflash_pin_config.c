...
const wiced_platform_gpio_t platform_gpio_pins[] =
    {
            ...
            //[PLATFORM_GPIO_1 ] = {WICED_P03, WICED_SPI_1_MOSI        },      //P03 does not work
            [PLATFORM_GPIO_1 ] = {WICED_P13, WICED_SPI_1_MOSI        },
            [PLATFORM_GPIO_2 ] = {WICED_P14, WICED_SPI_1_MISO        },
            //[PLATFORM_GPIO_3 ] = {WICED_P02, WICED_SPI_1_CS          },     //P02 does not work
            [PLATFORM_GPIO_3 ] = {WICED_P12, WICED_SPI_1_CS          },
            [PLATFORM_GPIO_4 ] = {WICED_P15, WICED_SPI_1_CLK         },
            [PLATFORM_GPIO_5 ] = {WICED_P28, WICED_I2C_1_SCL         },
            [PLATFORM_GPIO_6 ] = {WICED_P29, WICED_I2C_1_SDA         },
            [PLATFORM_GPIO_7 ] = {WICED_P37, WICED_UART_2_RXD        },
            [PLATFORM_GPIO_8 ] = {WICED_P32, WICED_UART_2_TXD        },
            [PLATFORM_GPIO_9 ] = {WICED_P26, WICED_GPIO              },      //LED 1
            [PLATFORM_GPIO_10] = {WICED_P27, WICED_GPIO              },      //LED 2
            [PLATFORM_GPIO_11] = {WICED_P09, WICED_SPI_2_CLK         },
            [PLATFORM_GPIO_12] = {WICED_P17, WICED_SPI_2_MISO         },
            [PLATFORM_GPIO_13] = {WICED_P06, WICED_SPI_2_MOSI         },
            [PLATFORM_GPIO_14] = {WICED_P11, WICED_SPI_2_CS           },
